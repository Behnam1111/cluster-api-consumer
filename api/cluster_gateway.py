...
async def create_group(group: Group, client: ClusterAPIConsumer = Depends(get_cluster_api_consumer)):
...
async def delete_group(group_id: str, client: ClusterAPIConsumer = Depends(get_cluster_api_consumer)):
